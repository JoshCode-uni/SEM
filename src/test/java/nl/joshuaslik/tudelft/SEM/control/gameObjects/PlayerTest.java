...
public class PlayerTest {
    ...
    public void testUpdateMoveLeft() {
        ...
        verify(image).setX(5 - Player.getMaxSpeed() / 100.0);
    ...
    /**
     * Tests if the right methods are called when trying to remove objects from the array
     */
    @Test
    ...
    /**
     * Tests if the doors are interacting in the correct way with the image when called by Update.
     */
    @Test
